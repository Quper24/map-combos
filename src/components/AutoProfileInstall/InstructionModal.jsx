      ...
      <div className="modal-window">
        ...
        <div className="modal-body">
          ...
          <div className="modal-status">
            🔒 Файл <code>profile.sii</code> передаётся на наш сервер <strong>только для расшифровки</strong>.
            После обработки он мгновенно удаляется и не сохраняется.
            Замена модов и скачивание готового файла происходят уже в вашем браузере.
          </div>
        </div>
      </div>
    </div>
